...
int main() {
  ...
  bat_native_confirmations::Confirmations C;
  C.test();
  std::string dummy_key("dummy_key");
  C.step_1_1_storeTheServersConfirmationsPublicKeyAndGenerator(dummy_key);
  C.step_2_1_batchGenerateTokensAndBlindThem();
  ...
  // std::cout<<"[SERVER] base64_signed_tok: "<<base64_signed_tok<<"\n";
  // // FIXME
  ...
  // std::cout<<"[CLIENT] base64_unblinded_tok: "<<base64_unblinded_tok<<"\n";
  ...
  //   std::cerr<<"ERROR: wrong sigs equal\n";
  //   return 1;
  // }
